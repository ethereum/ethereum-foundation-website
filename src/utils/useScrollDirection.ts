...
const useScrollDirection = () => {
  ...
  React.useEffect(() => {
    ...
    scrollIndicator.addEventListener("mousedown", forceScroll)
    scrollIndicator.addEventListener("touchstart", forceScroll)

    return () => {
      scrollIndicator.removeEventListener("mousedown", forceScroll)
      scrollIndicator.removeEventListener("touchstart", forceScroll)
    }
  }, [])
