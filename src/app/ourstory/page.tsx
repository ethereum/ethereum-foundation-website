  ...
  return (
    <ContentBlock>
      <div id="content-body" className="disable--selection">
        ...
        <p>Many of the early contributors to Ethereum joined the Foundation in order to lay groundwork for newcomers enticed by the same spark of curiosity and hope of what could be built here with time. They did so with the conviction that, under the right conditions and with some nurturing, Ethereum would grow into a living structure robust enough to be trusted by all humans, far into the future. </p>
        ...
        <p>What had started as a small homestead was fast becoming a <em>metropolis</em>. To those with experience in other worlds, the rapid growth during this era was exciting. The beautiful, sometimes strange creations that emerged from the prodigious innovation in the Ethereum commons became more complex by the day. </p>
        <p>As a steward of protocol development, the Foundation faced enormous pressure to help Ethereum scale in order to meet the needs of more and more users, as was the custom for companies selling products or services. But an organization is a very different thing from a protocol, and the Foundation needed a different way.</p>
        ...
        <p>Such growth came at a cost for the Merkle Tree, however. The weight of demand from so many was a heavy burden for its roots to bear, and made Ethereum more difficult and expensive than what users and builders deserved. Furthermore, the practice of mining Ether, which underpinned the consensus of the state, was perpetuating an unacceptable and catastrophic waste of energy. It had long been clear that Ethereum would have to change significantly to meet the needs of all users, present and future. But the Merkle tree was (and still is) rooted in consensus. Changes to the core Ethereum protocol would have to come from the general will of the whole ecosystem, not from be forced by an individual or faction's will to power. However anyone encouraged change, it would have to be one that worked within the pluralist constraints of public consensus.</p>
        <p>Instead, the Ethereum Foundation took on a role of coordination. A <MouseDownLink  href="https://blog.ethereum.org/2018/03/07/announcing-beneficiaries-ethereum-foundation-grants">new grants program</MouseDownLink> was created to help seed independent teams working towards the same goals as those <MouseDownLink  href="https://blog.ethereum.org/2019/06/21/ef-supported-teams-development-report-2019-pt-1">within the</MouseDownLink> Ethereum Foundation. A <MouseDownLink  href="https://blog.ethereum.org/2019/04/30/beginning-a-new-ethereum-org">community-driven hub for learners and teachers</MouseDownLink> was built to give all newcomers the ability to contribute to the long-term vision of Ethereum in time. <MouseDownLink  href="https://nxbn.ethereum.foundation/scholars">Scholarships</MouseDownLink> were given to make the largest and most vibrant Ethereum gatherings a little bit more accessible to everyone. All these efforts of coordination were to strengthen the capacity of the ecosystem itself, rather than the Foundation. The way of subtraction is a longer, less efficient, more uncertain path to walk &ndash; but it is the only one that winds through the beauty of decentralization. </p>
        ...
        <p>Ethereum will continue to grow and evolve in the coming years, striving to meet the needs and challenges of an ever-larger ensemble of human relationships. The Ethereum Foundation will remain a cast of benevolent characters in the story in this ecosystem, acting as arborists of the infinite garden or rangers of the dark forest: Planting seeds. Mapping territory. Building with uncut wood. </p>
        <p>Serenity is a process of becoming &ndash; a vision of the future that must be arrived at together as humans loosely coupled yet highly aligned. There will come a time when the Foundation's chapter in the story of Ethereum will be over, but the values it protected will persist in the soul of the protocol, and all those who enact it. </p>
        <blockquote>
          <em>
