  ...
  return (
    <ContentBlock>
      <div id="content-body" className="disable--selection">
        ...
        <p>Such growth came at a cost for the Merkle Tree, however. The weight of demand from so many was a heavy burden for its roots to bear, and made Ethereum more difficult and expensive than what users and builders deserved. Furthermore, the practice of mining Ether, which underpinned the consensus of the state, was perpetuating an unacceptable and catastrophic waste of energy. It had long been clear that Ethereum would have to change significantly to meet the needs of all users, present and future. But the Merkle tree was (and still is) rooted in consensus. Changes to the core Ethereum protocol would have to come from the general will of the whole ecosystem, not from any individual or faction's will to power. However anyone encouraged change, it would have to be one that worked within the pluralist constraints of public consensus.</p>
