      ...
      new Promise((resolve) => {
        ...
        if (url === "/philosophy") {
          if (webPFormatSupported) {
            if (screen.width < 500) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-philosophy-03-6000px.webp"
              )
            } else if (screen.width >= 500 && screen.width <= 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-philosophy-03-8000px.webp"
              )
            } else if (screen.width > 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-philosophy-03-12000px.webp"
              )
            }
          } else {
            if (screen.width < 500) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-philosophy-03-6000px.jpg"
              )
            } else if (screen.width >= 500 && screen.width <= 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-philosophy-03-8000px.jpg"
              )
            } else if (screen.width > 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-philosophy-03-12000px.jpg"
              )
            }
          }
        } else if (url === "/ef") {
          if (webPFormatSupported) {
            if (screen.width < 500) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ef-03-6000px.webp"
              )
            } else if (screen.width >= 500 && screen.width <= 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ef-03-8000px.webp"
              )
            } else if (screen.width > 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ef-03-12000px.webp"
              )
            }
          } else {
            if (screen.width < 500) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ef-03-6000px.jpg"
              )
            } else if (screen.width >= 500 && screen.width <= 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ef-03-8000px.jpg"
              )
            } else if (screen.width > 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ef-03-12000px.jpg"
              )
            }
          }
          ...
          if (webPFormatSupported) {
            if (screen.width < 500) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ethereum-03-6000px.webp"
              )
            } else if (screen.width >= 500 && screen.width <= 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ethereum-03-8000px.webp"
              )
            } else if (screen.width > 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ethereum-03-12000px.webp"
              )
            }
          } else {
            if (screen.width < 500) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ethereum-03-6000px.jpg"
              )
            } else if (screen.width >= 500 && screen.width <= 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ethereum-03-8000px.jpg"
              )
            } else if (screen.width > 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ethereum-03-12000px.jpg"
              )
            }
          }
          ...
          if (webPFormatSupported) {
            if (screen.width < 500) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-infinite-garden-03-6000px.webp"
              )
            } else if (screen.width >= 500 && screen.width <= 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-infinite-garden-03-8000px.webp"
              )
            } else if (screen.width > 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-infinite-garden-03-12000px.webp"
              )
            }
          } else {
            if (screen.width < 500) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-infinite-garden-03-6000px.jpg"
              )
            } else if (screen.width >= 500 && screen.width <= 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-infinite-garden-03-8000px.jpg"
              )
            } else if (screen.width > 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-infinite-garden-03-12000px.jpg"
              )
            }
          }
          ...
          if (webPFormatSupported) {
            if (screen.width < 500) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ourstory-01-6000px.webp"
              )
            } else if (screen.width >= 500 && screen.width <= 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ourstory-01-8000px.webp"
              )
            } else if (screen.width > 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ourstory-01-12000px.webp"
              )
            }
          } else {
            if (screen.width < 500) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ourstory-01-6000px.jpg"
              )
            } else if (screen.width >= 500 && screen.width <= 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ourstory-01-8000px.jpg"
              )
            } else if (screen.width > 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-ourstory-01-12000px.jpg"
              )
            }
          }
        } else if (isHomePage()) {
          if (webPFormatSupported) {
            if (screen.width < 500) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-landing-03-6000px.webp"
              )
            } else if (screen.width >= 500 && screen.width <= 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-landing-03-8000px.webp"
              )
            } else if (screen.width > 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-landing-03-12000px.webp"
              )
            }
          } else {
            if (screen.width < 500) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-landing-03-6000px.jpg"
              )
            } else if (screen.width >= 500 && screen.width <= 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-landing-03-8000px.jpg"
              )
            } else if (screen.width > 1700) {
              texture = backgroundLoader.load(
                "assets/EF-website-landscape-landing-03-12000px.jpg"
              )
            }
          }
        }
